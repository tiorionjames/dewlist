...
```
cd existing_repo
git remote add origin https://gitlab.galvanize.com/tiberius.james84/dewlist.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.galvanize.com/tiberius.james84/dewlist/-/settings/integrations)
